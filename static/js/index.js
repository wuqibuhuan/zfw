...
function formReset () {
  document.getElementById("lei-form").reset();
}
function addfrom () {
  document.getElementById("add-form").reset();
}
function reset () {
  document.getElementById("information-1").value = "";
  document.getElementById("information-2").value = "";
  document.getElementById("information-3").value = "";
  document.getElementById("information-4").value = "";
  document.getElementById("information-5").value = "";
  document.getElementById("information-6").value = "";
  document.getElementById("information-7").value = "";
  document.getElementById("information-8").value = "";
  document.getElementById("information-9").value = "";
  document.getElementById("test11").value = "";
  document.getElementById("test12").value = "";
...
//     }
//   });
//   var elem = $("#test2").find('.layui-tree-txt').css('color', ''); //搜索文本与设置默认颜色
//   if (!name) {
//     return; //无搜索值返回
//   }
...
function echartspony () {
  ...
  $.ajax({
    type: "post",
    url: basepath + "/search/folder/categoryAgg",
    // data: "data",
    async: false,
    dataType: "json",
    success: function (res) {
