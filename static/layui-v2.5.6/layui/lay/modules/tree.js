...
layui.define("form", function (e) {
  ...
  b.prototype.config = {
    ...
    layui.each(r, function (a, r) {
      ...
      var l = r.children && r.children.length > 0,
        ...
        h = i(['<div data-id="' + r.id + '" class="layui-tree-set' + (r.spread ? " layui-tree-spread" : "") + (r.checked ? " layui-tree-checkedFirst" : "") + '">', '<div class="layui-tree-entry">', '<div class="layui-tree-main">', function () {
          ...
          return r.href ? '<a href="' + r.href + '" target="_blank" class="' + y + '">' + "</a>" : '<span class="' + y + (r.uploaded ? " " + z : "") + (r.disabled ? " " + d : "") + '">' + (r.title || r.label || t.text.defaultNodeName) + "</span > "
        }(), "</div>", function () {
          if (!t.edit) return "";
          var e = {
            add: '<i class="layui-icon layui-icon-add-1 icon_add"  data-type="add" ></i>',
            update: '<i class="layui-icon layui-icon-edit icon_edit" data-type="update"></i>',
            del: '<i class="layui-icon layui-icon-delete icon_delete" data-type="del" ></i>'
          },
    ...
    l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function (l) {
      ...
      } else n.confirm('确认删除该节点 "<span style="color: #fff;">' + (a.title || "") + '</span>" 吗？', function (a) {
